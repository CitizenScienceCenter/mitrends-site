<i18n>
  ...
  "page-title": "The Swiss COH Cohort",

  "page-heading": "The Swiss COH Cohort"
...
<template>
  <div>
    ...
    <section-feedback email="hatespeech@citizenscience.ch" color="light-greyish"></section-feedback>
