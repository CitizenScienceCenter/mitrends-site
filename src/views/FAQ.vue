<i18n>
  ...
  "faq-3-answer": "<p>All the data is securely stored in your MIDATA account. You can access it anytime via <a href='https://ch.midata.coop/' target='_blank'>midata.coop</a>.<br>An evaluation of your exercises in comparison to other participants  will only be available once the study is completed.</p>",
  "faq-4-question": "What exercises do I have to do and what is my daily commitment?",
  "faq-4-answer": "<p>Currently, three exercises are implemented in MitrendS: The Lines exercise, the Points exercise and the Symbols exercise. In the Lines exercise, curved lines must be drawn one after the other with a pencil and both index fingers. In the Points exercise, three blue points are moved in three circles with thumb, index finger and middle finger. Both exercises serve to evaluate the motor function of hand and arm. All exercises can be performed by the patients at home. In addition, several questionnaires which have already been validated are stored in the app. Further exercises are currently being developed to expand the neurological examinations. The daily commitment is approximately 5 minutes, except for the first day: On that day it takes longer due to registration and Test Runs (approximately 15 minutes).</p>",
  "faq-5-question": "Do I get compensation?",
  "faq-5-answer": "<p class='reduced-bottom-margin'>You will not receive any compensation for participating in this study. You will receive an evaluation of your exercise results by email at the end of the study.</p>",
