      ...
      <div class="content-wrapper">
        <div class="row row-reverse-large">
          <div class="col col-tablet-portrait-7 col-large-6 col-large-after-1 col-wrapping col-large-no-bottom-margin scroll-effect">
            ...
            <p>
              Die Daten wurden durch uns anonymisiert, d.h. alle Namen und sonstigen persönlichen Informationen wurden nach bestem Wissen und Gewissen entfernt, oder im Falle von Vornamen verändert, um die Identität der Daten-SpenderInnen zu schützen. Für unsere Forschungsprojekte wurden die Daten auch weiter verarbeitet, z.B. wurden automatisch Wortarten identifiziert etc.
            </p>
          </div>
